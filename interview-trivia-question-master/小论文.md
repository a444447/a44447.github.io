...
我们提出了一个三阶段框架，它能够针对不同的物体生成有效的LED模式，从而攻击受害者模型。如图x所示，整个流程由下面几个过程组成:

(1) **physical attack space construction**

(2 )**coarse search for critical LED positions**, and
(3) **fine-grained brightness and color optimization**.
